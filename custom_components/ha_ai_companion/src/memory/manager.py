...
class MemoryManager:
    ...
    # Maximum total context characters injected into the system prompt.
    # Beyond this the content is summarised / truncated so the prompt stays
    ...
    async def write_file(self, filename: str, content: str) -> bool:
        ...
        The content is expected to be valid markdown.  A timestamp header
        is prepended automatically so the agent can track freshness.
