...
enable_cache_control: false     # Prompt caching (Anthropic Claude)
...
| Automation suggestions | Based on live entity states; avoids duplicating existing HA or Node-RED flows |
| Persistent memory | Remembers preferences and home layout across sessions |
| Conversation history | Sessions saved to disk, visible in the sidebar |
| Token usage display | Cumulative input/output/cached token counter in the UI footer |
